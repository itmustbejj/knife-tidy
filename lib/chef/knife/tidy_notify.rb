    ...
    class TidyNotify < Knife
      ...
      def run
        ...
        org_names.each do |org|
          ...
          email_content = generate_email(reports, org, email_recipients, report_files)
      ...
      def generate_email(report_data, organization, recipients, report_files)
...
MESSAGE_END
        ...
        report_files.each do |r_file|
          unless report_data[organization][r_file.split(organization)[1]].empty?
            message += <<MESSAGE_END
